...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "apple-mobile-web-app-title", content: "MindMate" },
      { name: "format-detection", content: "telephone=no" },
      { property: "og:title", content: "MindMate" },
      { property: "og:description", content: "Your AI companion for wellness, habits and growth." },
