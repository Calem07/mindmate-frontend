...
export function ScreenHeader({
  ...
  return (
    <header className="sticky top-0 z-40 flex items-center justify-between border-b border-white/5 bg-background/70 px-5 py-4 backdrop-blur-xl supports-[backdrop-filter]:bg-background/50">
      <div className="w-9">
        {back && (
          <button
